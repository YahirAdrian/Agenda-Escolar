    ...
    <body>
        ...
        // error_reporting(0);
            ...
            if($_SESSION["admin"] != "true"){
                ...
                echo "<script> setTimeout(()=> window.location = 'index.php', 20000);</script>";
            ...
            <section>
                        ...
                        <form action="php/insertar_tarea.php" method="post">
                            <div class="input-fields">
                                ...
                                <select name="materia" id="materia">
                                    ...
                                    <option value="ConstruyeT">ConstruyeT</option>
                                    <option value="ConstruyeT">agenda 6ampr</option>
                                </select>
                            </div>
                ...
                <div class="reuniones">
                    ...
                    <form class="programar-reuniones" id="programar-reuniones" style="display:none" method="POST" action="php/actualizar_reuniones.php">
                        <center><img src="src/Horario.jpg" alt="horario"/></center>
                        <table>
                            <thead>
                                <th>Materia</th>
                                <th>Hora inicio</th>
