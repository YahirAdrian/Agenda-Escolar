...
<html>
    ...
    <?php
        ...
        $conexion->close();
        //setcookie('usuarioid', $id, time()+60*60*24*7);
    ?>
    <header>
            <div class="logo">
            ...
            <div class="menu-final">
                ...
                <div class="caja-icono" id="icono-usuario">
                    <?php echo "<a href='perfil.php' id='foto' style='background: $foto'>"?>
                        <span id="nombre"><?= substr($nombres, 0, 1)?></span>
        ...
        <!--<script>
            function resetTbodyVencidos(){
                while(tbodyVencidos.firstChild){
                    tbodyVencidos.firstChild.remove();
                }
            }
            function updateRealTime(){
                var tabla = $.ajax({
                    url: 'imprimirTareas.php',
                    dataType: 'text',
                    async: false,
                }).responseText;
                
                 tablaTareas.querySelector('tbody').innerHTML = tabla;
                resetTbodyVencidos();
                moverTareas();
